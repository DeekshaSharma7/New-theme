    ...
    <div>
        ...
        <section className="banner position-relative pb-0">
            ...
            <video className="banner-video" autoPlay muted loop playsInline>
                <source src="assets/videos/ab.mp4" type="video/mp4" />
                        ...
                        <div className="col-lg-6 order-2 order-lg-1">
                            <div className="banner-left text-center pb-lg-5 p-md-0">
                                <div className="banner-image">
                                    <div className="banner-image">
  <div style={{ width: "50%", height: "300px", background: "transparent" }} />
</div>
                        ...
                        <div className="col-lg-6 order-1 order-lg-2 text-black">
                            ...
                            <div className="banner-title pb-3">
                                <h4 className="text-black pb-3">UPCOMING NEW <span className="pink">EVENT</span> 2023</h4>
                                <h1 className="text-black">STARTUP <span className="pink">GLOBAL</span> CONFERENCE</h1>
                            </div>
